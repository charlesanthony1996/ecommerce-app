                    ...
                    <div className="flex gap-4 md:gap-8 items-center dark:text-white">
                        ...
                        <div className="flex items-center gap-2">
                            {username !== "" ? (
                                ...
                                <FaUser className="text-gray-500 text-2xl dark:text-white"></FaUser>
                            )}
                        ...
                        data-test="cart-btn"
                        >
                            <AiOutlineShoppingCart className="dark:text-white"></AiOutlineShoppingCart>
                            <div
                        ...
                        >
                            {isDarkMode ? (
                                <MdOutlineLightMode className="cursor-pointer" size={30}></MdOutlineLightMode>
                            ): (
                                <MdOutlineDarkMode className="cursor-pointer" size={30}></MdOutlineDarkMode>
                            )}
                        </div>
                    </div>
                </div>
